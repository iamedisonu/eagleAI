...
const MentorCard = ({ mentor }) => {
  return (
    ...
    <div className="border-2 border-gray-200 rounded-lg md:rounded-xl p-4 md:p-6 hover:shadow-xl transition-all hover:border-[#003459] bg-gradient-to-br from-white to-blue-50">
      ...
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-3 mb-3 md:mb-4">
        ...
        <div className="text-center bg-gradient-to-br from-green-500 to-green-600 text-white px-4 md:px-5 py-2 md:py-3 rounded-xl shadow-md flex-shrink-0 self-start sm:self-auto">
      ...
      {/* Success Insight box */}
      <div className="bg-yellow-50 border-l-4 border-[#C8102E] p-3 md:p-4 rounded-lg mb-3 md:mb-4">
        <div className="flex items-start gap-2">
          <Star size={16} className="text-[#C8102E] mt-0.5 flex-shrink-0" />
          <div className="min-w-0 flex-1">
